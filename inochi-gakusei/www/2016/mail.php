...
$site_top = "http://inochi-gakusei.com/2016";
...
$thanksPage = "http://inochi-gakusei.com/2016/thanks.html";
...
$require = array('学校区分','氏名','所属','Email');
...
$refrom_name = "inochi学生フォーラム運営事務局";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "■inochi学生フォーラム■参加お申込みありがとうございました";
...
inochi学生フォーラムへの参加ご応募、ありがとうございました。

若者から医療を変える、その最前線へようこそ。
教育プログラムからプランの実現まで、inochi学生フォーラムでは充実したプログラムをご用意しております。

ご参加にあたり選考をする場合がございます。
皆様の参加意欲・人柄や活動によって参加の可否を運営事務局にて判断させていただきます。
つきましては、<<必ず>>以下のURLより参加希望動機等、必要事項をご記入ください。
▼▼----参加必要事項記入フォーム----▼▼
http://goo.gl/forms/EKyinL9m1Qe7rjtj1
▲▲---------------------------▲▲


参加応募者には近日中に応募者多数の場合の選考、または参加可否について、メールにてご連絡差し上げます。
皆様とともに、「心臓突然死減少」というテーマに立ち向かっていく日々をスタッフ一同心待ちにしております。


■------------------■
向き合おう、inochiと。
【inochi学生フォーラム特設サイト】
http://inochi-gakusei.com/2016
上記のwebサイトをSNSでシェアして、お友達とともに参加しましょう!!


こちらからは課題解決のためのシミュレーションができます。
【inochiシミュレータ】
http://inochi-gakusei.com/2016/simulator/
■------------------■
...
──────────────────────
[主催]inochi学生プロジェクト内　inochi学生フォーラム運営事務局
http://inochi-gakusei.com/2016
[お問い合わせ]info@inochi-gakusei.com
